...
REM call %cd%\depot_tools\python276_bin\python .\ld-favorsize.py .\v8\build\toolchain.gypi

REM call "%cd%\depot_tools\python276_bin\python" %cd%\v8\build\gyp_v8 -Dv8_enable_i18n_support=0 -Dv8_use_snapshot=0 -Dcomponent=shared_library
